defmodule UserDemo.UserContext.User do
  ...
  def changeset(user, attrs) do
    ...
    |> unique_constraint(:date_of_birth, name: :unique_users_index,
    message: "Wow that's a coincidence!" <> "Another person with the same first name and last name was born at this day. " <>
